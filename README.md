...
- [UNDER DEVELOPMENT] [Computer Repair Shop Ticketing System](https://github.com/kharizzakaye/repair-shop-ticketing-system) - A fullstack passwordless ticketing system for a computer repair shop - created with React, Next.js, Typescript, Shadcn UI, Tailwind, Sentry, Kinde, Neon, Drizzle ORM, React Hook Form and Zod.
